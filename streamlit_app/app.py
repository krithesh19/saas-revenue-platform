...
'>
    ...
    <p style='color: #aaa; margin: 0; font-size: 16px;'>
...
'>
    ...
    <div style='text-align:center; margin-top:5px;'>
        <p style='color:#888; font-size:11px; margin-bottom:8px;'>⚙️ GitHub Actions CI/CD — Automated dbt tests on every push</p>
        <div style='display:flex; justify-content:center; gap:8px; flex-wrap:wrap;'>
            <span style='background:#0f3460; border-radius:20px; padding:4px 12px; color:#00D4FF; font-size:11px; border:1px solid #333;'>💬 AI Analyst</span>
            <span style='background:#0f3460; border-radius:20px; padding:4px 12px; color:#00D4FF; font-size:11px; border:1px solid #333;'>📈 Forecasting</span>
            <span style='background:#0f3460; border-radius:20px; padding:4px 12px; color:#00D4FF; font-size:11px; border:1px solid #333;'>📊 Budget vs Actuals</span>
            <span style='background:#0f3460; border-radius:20px; padding:4px 12px; color:#00D4FF; font-size:11px; border:1px solid #333;'>💰 Unit Economics</span>
            <span style='background:#0f3460; border-radius:20px; padding:4px 12px; color:#00D4FF; font-size:11px; border:1px solid #333;'>🔄 Cohort Analysis</span>
            <span style='background:#0f3460; border-radius:20px; padding:4px 12px; color:#00D4FF; font-size:11px; border:1px solid #333;'>⚡ Quick Ratio</span>
        </div>
    </div>
</div>
""", unsafe_allow_html=True)
...
for col, (icon, name, rows, desc) in zip([col1,col2,col3,col4,col5], tables):
    col.markdown(f"""
    <div style='
        background: linear-gradient(135deg, #0f3460, #1a1a2e);
        border-radius: 10px;
...
pages = [
    ...
    ("💎", "Customer LTV",       "LTV distribution, cohort line chart, top customers"),
